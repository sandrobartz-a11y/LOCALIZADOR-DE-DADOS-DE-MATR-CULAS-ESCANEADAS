...
Tenho meus estudos voltados para **Python, SQL, Power BI, ETL, Machine Learning** e estou cursando pós-graduação em **Big Data Ciência de Dados** e **Ciência de Dados e Machine Learning**.
...
- **Ferramentas**:
  - [Azure AI Document Intelligence](https://azure.microsoft.com/en-us/services/formfício**: Reconhecimento preciso de documentos complexos, incluindo tabelas e carimbos.
...
- Bancos como **BBVA México** e **Bank of America** usam IA para análise de crédito e prevenção de fraudes.
- **ONR Brasil** integra IA do Google Cloud para digitalização de matrículas e automação registral.
- Plataformas globais como **Blue Prism** e **UiPath** lideram IDP e RPA em instituições financeiras.

---

📫 **Contato**
- LinkedIn: https://www.linkedin.com/in/sandro-bartz-4a8038381
- GitHub: https://github.com/sandrobartz-a11y
- E-mail: sandrobartz@gmail.com
